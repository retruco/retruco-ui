        ...
        Nothing ->
            let
                ...
                language =
                    model.language
            in
                case ( model.affirmation, model.toolbarModel ) of
                    ( Just affirmation, Just toolbarModel ) ->
                        div []
                            [ div [ class "align-items-center d-flex flex-nowrap justify-content-between mb-3" ]
                                ...
                                , viewStatementRatingPanel language (ForParent << Navigate) Nothing affirmation
                                ]
                            ...
                            , ul [ class "nav nav-tabs" ]
                                [ li [ class "nav-item" ]
                                    [ aForPath
                                        (ForParent << Navigate)
                                        language
                                        (Urls.idToDebatePropertiesPath data affirmation.id)
                                        [ classList
                                            [ ( "active"
                                ...
                                , li [ class "nav-item" ]
                                    [ aForPath
                                        (ForParent << Navigate)
                                        language
                                        (Urls.idToPropertiesPath data affirmation.id)
                                        [ classList
                                ...
                                , li [ class "nav-item" ]
                                    [ aForPath
                                        (ForParent << Navigate)
                                        language
                                        ((Urls.idToPath data affirmation.id) ++ "/details")
                                        [ classList
                            ...
                            , case model.activeTab of
                                ...
                                PropertiesTab ->
                                    viewStatementPropertiesBlock language (ForParent << Navigate) data affirmation
                            ]
                        ...
                        case model.httpError of
                            Just httpError ->
                                div
                                    ...
                                    [ strong []
                                        [ text <|
                                            I18n.translate language I18n.AffirmationRetrievalFailed
