module Questions.New.Types exposing (..)
...
type alias MsgTranslation parentMsg =
    ...
    , onQuestionUpserted : DataId -> parentMsg
...
translateMsg { onInternalMsg, onQuestionUpserted, onRequireSignIn } msg =
    case msg of
        ForParent (QuestionUpserted data) ->
            onQuestionUpserted data
