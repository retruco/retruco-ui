module Questions.New.State exposing (..)
...
update msg model =
    case msg of
        ...
        ProposalUpserted data ->
            ...
            , Requests.postProperty model.authentication model.objectId "question" data.id (Just 1)
        ...
        Upserted (Ok body) ->
            ...
            in
                ( mergedModel
                , Task.perform (\_ -> ForParent <| QuestionUpserted data) (Task.succeed ())
                )
...
urlUpdate location model =
    ...
    in
        ...
        , Ports.setDocumentMetadata
            { description = I18n.translate language I18n.NewQuestionDescription
            , imageUrl = Urls.appLogoFullUrl
            , title = I18n.translate language I18n.NewQuestion
            }
        )
