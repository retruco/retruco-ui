...
init authentication embed language objectId =
    ...
    , data = initData
    , embed = embed
    , ideaProperties = Array.empty
    , language = language
    , newInterventionModel = Interventions.New.State.init authentication embed language objectId "idea" [ "idea" ]
    , objectId = objectId
    , showTrashed = False
    }
...
update msg model =
    case msg of
        ...
        NewInterventionMsg childMsg ->
            ...
            in
                ( { model | newInterventionModel = updatedNewIdeaModel }
