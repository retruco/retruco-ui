module Arguments.Item.State exposing (..)

import Arguments.New.State
import Arguments.Item.Routes exposing (..)
    ...
    case msg of
        ...
        RatingPosted (Ok { data }) ->
            ...
            , if data.id == model.id then
                ...
                -- The rating of an argument may have changed => the argument rating may also have changed.
                -- => Retrieve it.
